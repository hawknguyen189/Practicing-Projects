...
let api = function Binance(options = {}) {
  ...
  return {
    ...
    openOrders: function (symbol, callback) {
      ...
      if (!callback) {
        return new Promise((resolve, reject) => {
          ...
          signedRequest(base + "v3/openOrders", parameters, function (
            error,
            data
          ) {
            return callback.call(this, error, data, symbol);
    ...
    cancelOrders: function (symbol, callback = false) {
      if (!callback) {
        return new Promise((resolve, reject) => {
          ...
          signedRequest(base + "v3/openOrders", { symbol }, function (
            error,
            json
          ) {
            if (json.length === 0) {
        ...
        signedRequest(base + "v3/openOrders", { symbol: symbol }, function (
          error,
          json
        ) {
          if (json.length === 0) {
    ...
    allOrders: function (symbol, callback, options = {}) {
      ...
      if (!callback) {
        return new Promise((resolve, reject) => {
          ...
          signedRequest(base + "v3/allOrders", parameters, function (
            error,
            data
          ) {
            return callback.call(this, error, data, symbol);
    ...
    trades: (symbol, callback, options = {}) => {
      ...
      if (!callback) {
        return new Promise((resolve, reject) => {
          ...
          signedRequest(base + "v3/myTrades", parameters, function (
            error,
            data
          ) {
            return callback.call(this, error, data, symbol);
    ...
    mgAllOrders: function (symbol, callback, options = {}) {
      ...
      if (!callback) {
        return new Promise((resolve, reject) => {
          ...
          signedRequest(sapi + "v1/margin/allOrders", parameters, function (
            error,
            data
          ) {
            return callback.call(this, error, data, symbol);
    ...
    mgOrderStatus: function (symbol, orderid, callback, flags = {}) {
      ...
      signedRequest(sapi + "v1/margin/order", parameters, function (
        error,
        data
      ) {
        if (callback) return callback.call(this, error, data, symbol);
    ...
    mgOpenOrders: function (symbol, callback) {
      let parameters = symbol ? { symbol: symbol } : {};
      signedRequest(sapi + "v1/margin/openOrders", parameters, function (
        error,
        data
      ) {
        return callback.call(this, error, data, symbol);
